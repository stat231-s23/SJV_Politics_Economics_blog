...
library(zoo)
```
Shreya's Code (Is this supposed to be here?)
...
Literacy2023table <- read.csv("data/LiteracyRate2023.csv")

Literacy <- select(Literacy2023table, "growthRate", "country", "region", "rank", "latestRate", "dataYear", "pop2023", "landAreaKm", "density")
