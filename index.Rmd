...
Our next analysis attempts sort countries according to

(The picture is more complicated than the one indicated by the delineation into north and south accomplished by HDI).
```{r}
#JESSE
